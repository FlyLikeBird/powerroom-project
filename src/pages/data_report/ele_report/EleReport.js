...
function EleReportManager({ dispatch, costReport, global }){
    ...
    useEffect(()=>{
        ...
        dispatch({ type:'costReport/fetchEleReport'});
        return ()=>{
...
export default connect(({ costReport, global })=>({ costReport, global }))(EleReportManager);