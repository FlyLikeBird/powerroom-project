...
import loginTitle from '../../../public/login_title.png';
...
function LoginPage({ dispatch, global }) {  
    const { thirdAgent } = global;
                            ...
                            <Button type="primary" style={{width:'100%', height:'40px'}} onClick={()=>{
                                ...
                                .then(values=>{
                                    new Promise((resolve,reject)=>{
                                        dispatch({type:'global/login', payload:values, resolve, reject })
                                    }).then(()=>{})
                                    .catch(msg=>{
                                        message.error(msg);
                                    })
