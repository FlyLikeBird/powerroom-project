...
// function translateDataToSheet(data, sheetName, merge) {
//     var temp = data[0];
//     data.unshift({});
//     var keyMap = []; //获取keys
//     for (var k in temp) {
