...
export var modelList = [
    { path:'transformer_mini.gltf', type:'transformer', name:'3#变压器', mach_id:'2912015249' }, 
    { path:'transformer_mini.gltf', type:'transformer', name:'1#变压器', mach_id:'3106084080' }, 
    { path:'transformer_mini.gltf', type:'transformer', name:'2#变压器', mach_id:'3106084081' }, 
    ...
    { path:'inlineBox_mini.gltf', type:'inlineBox', name:'进线柜4' },
    ...
    { path:'inlineBox_mini.gltf', type:'inlineBox', name:'进线柜5' },
    { path:'inlineBox_mini.gltf', type:'inlineBox', name:'进线柜6' },
];
